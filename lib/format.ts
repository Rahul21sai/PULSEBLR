...
const CATEGORY_ACCENTS: Record<string, string> = {
  ...
  'Robotics/Hardware': '#8E8E93',
  'Open Source': '#30D158',
  'Gaming/XR': '#FF2D55',
  'Hackathon': '#FF375F',
  'Startup/Founders': '#FF9F0A',
  'Product/Design': '#BF5AF2',
  'Marketing/Growth': '#FF6482',
  'Career/Job Fair': '#0071E3',
  'Summit/Conference': '#64D2FF',
  'Workshop/Training': '#32ADE6',
  'Corporate': '#636366',
  'Government': '#8E8E93',
  'Networking/Meetup': '#FF9500',
  'Business/Finance': '#248A3D',
  'Health/Biotech': '#30D158',
  'Science/Research': '#5E5CE6',
  'Climate/Sustainability': '#34C759',
  'Music/Nightlife': '#FF2D55',
  'Arts/Culture': '#BF5AF2',
  'Comedy/Theatre': '#FF9F0A',
  'Sports/Fitness': '#32D74B',
  'Food/Drink': '#FF6961',
  'Books/Writing': '#A2845E',
  'Social/Community': '#FF9500',
  'Other': '#8E8E93',
};
